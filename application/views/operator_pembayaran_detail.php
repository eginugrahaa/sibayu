<div class="m-portlet m-portlet--mobile">
        ...
        <div class="m-portlet__head-tools">
            <ul class="m-portlet__nav">
                <li class="m-portlet__nav-item">
                    <a href="<?php echo base_url('operator/pembayaran'); ?>" class="btn btn-metal m-btn m-btn--custom m-btn--pill m-btn--icon m-btn--air btn-sm">
                        <span>
    ...
    <div class="m-portlet__body">
        ...
        <div class="form-group m-form__group row">
            ...
            <div class="col-lg-3" >
                <?php echo anchor('operator/pembayaran_tambah/'.$peserta["peserta_id"],'<button class="btn btn-success m-input btn-lg" style="width: 100% !important;">Bayar Tagihan</button>',''); ?>
                <?php echo anchor('operator/pembayaran_cetak_riwayat/'.$peserta["peserta_id"],'<button class="btn btn-info m-input btn-sm " style="width: 100% !important; margin-top: 10px;">Cetak Riwayat Tagihan</button>',''); ?>
...
<div class="m-portlet m-portlet--mobile">
    ...
    <div class="m-portlet__body">
        <div class="table-responsive">
            <?php echo form_open('operator/pembayaran_transaksi_hapus'); ?>
                                ...
                                echo '
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            '.anchor('operator/pembayaran_cetak/'.$row_transaksi["transaksi_id"],'<span class="m-badge m-badge--info m-badge--wide" style="border-radius: 0px;">cetak bukti</span>').'
                                        </td>
                                    </tr>
                                ';
