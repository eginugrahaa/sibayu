<div class="m-portlet m-portlet--mobile">
        ...
        <div class="m-portlet__head-tools">
            <ul class="m-portlet__nav">
                <li class="m-portlet__nav-item">
                    <a href="<?php echo base_url('superuser/pembayaran_detail/'.$row["peserta_id"]); ?>" class="btn btn-metal m-btn m-btn--custom m-btn--pill m-btn--icon m-btn--air btn-sm">
                        <span>
    ...
    <div class="m-portlet__body">
        ...
        <div id="cetak_nilai" class="land-print" style="border:1px dashed #777; padding: 10px;">
            ...
            <?php echo form_open('superuser/pembayaran_rincian_hapus'); ?>
                            ...
                            foreach($rincian as $row_rincian){
                                ...
                                echo '
                                    <tr>
                                        ...
                                        <td><input class="no-print" type="checkbox" name="kode_id[]" value="'.$row_rincian["rincian_id"].'" id="checbox_id"/></td>
                                    </tr>
                                ';
                                $no++;
