<div class="m-portlet m-portlet--mobile">
        ...
        <div class="m-portlet__head-tools">
            <ul class="m-portlet__nav">
                ...
                <li class="m-portlet__nav-item">
                    <a href="<?php echo base_url('superuser/tagihan_tambah'); ?>" class="btn btn-accent m-btn m-btn--custom m-btn--pill m-btn--icon m-btn--air btn-sm">
                        <span>
    ...
    <div class="m-portlet__body">
        ...
        <?php echo form_open('superuser/tagihan_filter'); ?>
        <div class="form-group m-form__group row">
            ...
            <div class="col-lg-3">
                ...
                <?php echo form_dropdown('filter_kelas', $tahun_masuk, $value_kelas, 'class="form-control m-input"'); ?>
            </div>
            <div class="col-lg-2">
                <label class="">&nbsp;</label>
            ...
            <?php
                if(!$this->session->userdata('filter_nama') OR !$this->session->userdata('filter_kelas')){
                    ...
                    <div class="col-lg-1">
                        <label class="">&nbsp;</label>
                        '.anchor('superuser/tagihan','<i class="la la-refresh"></i>','title="Reset Filter" class="btn form-control btn-default m-input"').'
                    </div>
                    ';
                }
            ?>
        ...
        <?php echo form_close(); ?>
        <!--begin: Datatable -->
        <?php echo form_open('superuser/tagihan_hapus'); ?>
        ...
        <table class="table table-striped table-bordered table-hover table-checkable m-datatable--brand" id="m_table_1" style="width:99.9%;">
            <thead class="btn-brand">
                <tr>
                    ...
                    <th class="text-left" width="100px">Tipe</th>
                    <th class="text-left" width="120px">Tahun Masuk</th>
                    ...
                    foreach ($query as $row) {
                        echo"
                            <tr>
                                ...
                                <td align='left'>".$row["nama_tagihan"]."</td>
                                <td align='right'>".rupiah($row["nominal"])."</td>
                                <td align='left'>".$row["tipe_tagihan"]."</td>
                                <td align='left'>".$row["nama_tahun_masuk"]."</td>
                                <td align='center'>".getActive($row["aktif_tagihan"])."</td>
                                <td align='center'>
                                    ".anchor('superuser/tagihan_edit/'.$row['tagihan_id'],'<i class="la la-edit"></i> Edit')." 
                                </td>
                                <td class='text-center'>
                                    <input type='checkbox' name='kode_id[]' value='".$row["tagihan_id"]."' id='checbox_id'/>
                                </td>
                            </tr>
                        ";
                        $no++;
