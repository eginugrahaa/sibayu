<div class="m-portlet m-portlet--mobile">
    ...
    <?php echo form_open('superuser/tahun_masuk_edit/'.$tahun_masuk_id,'class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed"'); ?>
        <div class="m-portlet__body">	
            <div class="m-form__section m-form__section--first">
                ...
                <?php echo form_hidden('tahun_masuk_id', $tahun_masuk_id); ?>
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-6">
                        <?php
                            ...
                            <span class="m-form__help">[Active] = tahun masuk masih aktif. [Deactive] = tahun masuk tidak aktif.</span>
                    </div>
                </div>
            </div>
        </div>
