<div class="m-portlet m-portlet--mobile">
    ...
    <?php echo form_open('superuser/peserta_tambah','class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed"'); ?>
        <div class="m-portlet__body">	
            <div class="m-form__section m-form__section--first">
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-6">
                        <input name="peserta_id" type="number" min="1" class="form-control m-input" placeholder="..." value="<?php echo $peserta_id; ?>" required>
